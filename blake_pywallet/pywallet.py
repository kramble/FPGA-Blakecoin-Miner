...
def ASecretToSecret(sec):
	...
	if not vch:
		return False
	if addrtype==26 and vch[0] != chr((128)&255):	#blake
		print 'Warning: adress prefix seems bad (%d vs %d)'%(ord(vch[0]), (addrtype+128)&255)
	elif addrtype!=26 and vch[0] != chr((addrtype+128)&255):
		print 'Warning: adress prefix seems bad (%d vs %d)'%(ord(vch[0]), (addrtype+128)&255)
	return vch[1:]
